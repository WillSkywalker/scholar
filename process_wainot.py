...
# Preprocess a wainot corpus to extract the text of each article, remove punctuation, and write it all
...
def main():
    ...
    files = glob.glob(os.path.join(input_dir, 'Data', 'wainot*'))
    files.sort()
    ...
    for f in files:
        ...
        with codecs.open(f, 'r', encoding='utf-8') as f:
            ...
            text = clean_text(soup.find('title').text) + ' '
